        ...
        <div class="d-flex align-items-end row">
          <div class="col-7">
            <div class="card-body text-nowrap">
              ...
              <h4 class="text-white mb-1"><?= $quiz->quizObject->num_of_questions ?></h4>
              <a href="<?= Url::to(['reports/view', 'id' => $quiz->id, 'moderated' => true]) ?>" class="btn <?= $class ?> rounded-pill waves-effect waves-light">
                <?= $text . ' ' . $icon ?>
              </a>
            </div>
          </div>
