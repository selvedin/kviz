...
class CardView extends \yii\bootstrap5\Widget
{
    ...
    public function run()
    {
        echo "<div><h3>$this->title</h3><div class='row'><div class='col-md-12'><div class='card card-action'><div class='card-header bg-$this->type'>";
        ...
        echo "</div></div>";
        echo "<div class='card-$this->marginless $this->amiri'>$this->content</div>";
